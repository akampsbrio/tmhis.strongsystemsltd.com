# TMHIS System Documentation

Welcome to the technical and educational documentation for the **Technology-Mediated Homeschooling Information System (TMHIS)** (Makerere University, Master of Science in Information Systems Plan B Project).

---

## Documentation Directory

- [**System Architecture & PWA Offline Engine**](file:///home/tmhis/htdocs/tmhis.strongsystemsltd.com/docs/architecture.md)
  - Detailed layered architecture, PWA Service Worker caching strategy, IndexedDB storage, and client UUID sync engine.
- [**Database Schema & Data Dictionary**](file:///home/tmhis/htdocs/tmhis.strongsystemsltd.com/docs/database.md)
  - MySQL 8.0 schema breakdown, relational foreign keys, and indexing policies.
- [**REST API Reference & Conventions**](file:///home/tmhis/htdocs/tmhis.strongsystemsltd.com/docs/api.md)
  - Standard JSON response envelopes, status codes, authentication headers, and endpoint definitions.
- [**Module Implementation Guides**](file:///home/tmhis/htdocs/tmhis.strongsystemsltd.com/docs/modules/index.md)
  - Sprint-by-sprint implementation details for all 13 modules.

---

## Module Status & Implementation Progress

| Module | Title | Sprint | Status | Tests Passing |
| :--- | :--- | :--- | :--- | :--- |
| **Module 00** | [System Foundation & PWA Shell](file:///home/tmhis/htdocs/tmhis.strongsystemsltd.com/docs/architecture.md) | Sprint 0 | ✅ **Completed** | Core Architecture |
